            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <br>
                        <br>
                        <h2><em>Chi tiết <em>sản phẩm</em></h2>
        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="border rounded-4 mb-3 d-flex justify-content-center">
                    ...
                    <img style="max-width: 100%; max-height: 100vh; margin: auto;" class="rounded-4 fit" src="/images/products/{{ $sp->image }}" />
                    </a>
                </div>
                ...
                <div class="ps-lg-3">
                    ...
                    <div class="mb-3">
                        <span class="h5">{{ number_format($sp->unit_price) }} VND</span>
                    ...
                    <div class="row">
                    <dt class="col-3">Phân loại:</dt>
                    <dd class="col-9">{{ $loai->name }}</dd>
                    ...
                    <a href="{{ route('banhang.addToCart', $sp->id) }}" class="btn btn-primary shadow-0"> <i class="me-1 fa fa-shopping-basket"></i> Add to cart </a>
                ...
                <div class="col-lg-8 mb-4">
                    <div class="border rounded-2 px-3 py-2 bg-white">
                        ...
                        <li class="nav-item d-flex" role="presentation">
                            <a class="nav-link d-flex align-items-center justify-content-center w-100 active" id="ex1-tab-1" data-mdb-toggle="pill" href="#ex1-pills-1" role="tab" aria-controls="ex1-pills-1" aria-selected="true">Đặc Biệt!</a>
                        </li>
                        {{-- <li class="nav-item d-flex" role="presentation">
