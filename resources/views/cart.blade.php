...
@section('css')
<link rel="stylesheet" href="/function/assets/dest/css/font-awesome.min.css">
<link rel="stylesheet" href="/function/assets/dest/vendors/colorbox/example3/colorbox.css">
<link rel="stylesheet" href="/function/assets/dest/rs-plugin/css/settings.css">
<link rel="stylesheet" href="/functionfunction/assets/dest/rs-plugin/css/responsive.css">
<link rel="stylesheet" title="style" href="/function/assets/dest/css/style.css">
<link rel="stylesheet" href="/function/assets/dest/css/animate.css">
<link rel="stylesheet" title="style" href="/function/assets/dest/css/huong-style.css">
@endsection
@section('content')
                    ...
                    <tbody>
                        ...
                        <tr class="cart_item">
                            <td class="product-name">
                                <div class="media">
                                    <img class="pull-left" src="/images/{{ $cart['item']->image }}" alt="">
                            ...
                            <td class="product-price">
                                <span class="amount">{{ $cart['item']->promotion_price != 0?number_format($cart['item']->promotion_price,0):
